...
class ItineraireServices {
  ...
  static Future<LatLng?> getCoordLieu(String lieu) async {
    ...
    final url = Uri.parse('https://nominatim.openstreetmap.org/search?q=${Uri.encodeComponent(lieu)}&format=json&limit=1');
    ...
    try {
      ...
      print('Erreur lors de la recherche du lieu : $e');
    }
    return null;
  }
